...
namespace LibraryManager.Infrastructure.Migrations
{
    ...
    [Migration("20211005142450_CreateAuthorFKInBooks")]
    partial class CreateAuthorFKInBooks
    {
            ...
            modelBuilder.Entity("LibraryManager.Domain.Entities.Author", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreateDate")
                        ...
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 10, 5, 14, 24, 50, 537, DateTimeKind.Unspecified).AddTicks(5032), new TimeSpan(0, 0, 0, 0, 0)));
            ...
            modelBuilder.Entity("LibraryManager.Domain.Entities.Book", b =>
                {
                    ...
                    b.Property<DateTimeOffset>("CreateDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("timestamp with time zone")
                        .HasDefaultValue(new DateTimeOffset(new DateTime(2021, 10, 5, 14, 24, 50, 547, DateTimeKind.Unspecified).AddTicks(754), new TimeSpan(0, 0, 0, 0, 0)));
